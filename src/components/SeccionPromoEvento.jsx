...
import ModalConsulta from "../components/ModalConsulta/ModalConsulta.jsx";
    ...
    <>
      <section className="seccion-promo-evento">
        ...
        <div className="promo-contenido">
          ...
          {/* Botón de reserva → abre el modal */}
          <button
      ...
      {/* Modal — montado fuera del section para no heredar overflow:hidden */}
      <ModalConsulta
        isOpen={modalAbierto}
